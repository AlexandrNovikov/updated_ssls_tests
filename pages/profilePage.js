...
// Actions
    ...
    checkValuesInProfile(defaultUserProfileInfo, newUserProfileInfo){
        for (let key in defaultUserProfileInfo){
            assert.equal(true, defaultUserProfileInfo[key] === newUserProfileInfo[key]);
        }
    }
};