...
// Scenario for Test Case 6 and Test Case 7
    ...
    let defaultUserProfileInfo = yield* profilePage.getAllProfileValues();
    ...
    I.seeOpenedPage('Profile');
    let newUserProfileInfo = yield* profilePage.getAllProfileValues();
    profilePage.checkValuesInProfile(defaultUserProfileInfo, newUserProfileInfo)
});
